...
export default {
  messages: {
    ...
    [KEYS.ABOUT_PAGE_SECOND_PARAGRAPH_TITLE]: 'ما هو تحدي ترتيل 100,000 ؟',
    [KEYS.ABOUT_PAGE_SECOND_PARAGRAPH_TEXT_1]:
      'الهدف من تحدي ترتيل 100,000 هو بناء أول مجموعة بيانات عامة في العالم للتلاوات القرآنية التي يقوم بها المسلمون العاديون. معظم التسجيلات الصوتية المتاحة للقرآن تتلى من القراء المحترفين ذوي الطلاقة القوية في التجويد (قواعد التلاوة) ويتم تسجيلها في الاستوديوهات. هذا أمر مهم عندما يريد شخص الاستماع إلى تلاوة القرآن.',
